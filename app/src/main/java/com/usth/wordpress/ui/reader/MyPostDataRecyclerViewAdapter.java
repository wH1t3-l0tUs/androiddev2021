...
public class MyPostDataRecyclerViewAdapter extends RecyclerView.Adapter<MyPostDataRecyclerViewAdapter.ViewHolder> {

    private final List<PostData> mValues;

    public MyPostDataRecyclerViewAdapter(List<PostData> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_trending_item, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View view, Context context) {
            super(view);
            mView = view;
            mTitle = (TextView) view.findViewById(R.id.item_title_trending);
            circleImageView = (CircleImageView) view.findViewById(R.id.image_avatar_user_trending);
            mUsername = (TextView) view.findViewById(R.id.text_username_user_trending);
            mImagePanel = (ImageView) view.findViewById(R.id.item_image_panel_trending);
